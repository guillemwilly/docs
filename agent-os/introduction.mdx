...
**AgentOS is a FastAPI application that runs your agent platform.** It is a live service that:
...
Build your agents using the [Agno SDK](/sdk/introduction), run them using the AgentOS.
