...
| :--- | :--- | :--- | :--- |
| [Docker](/deploy/templates/docker) | Local development, testing, self-hosting | Develop locally or deploy to any platform that support docker | ~5 min |
| [Railway](/deploy/templates/railway) | Quick production deployments, MVPs | Ship fast without managing infrastructure | ~10 min |
| [AWS](/deploy/templates/aws) | Production at scale, enterprise | Production-grade reliability and enterprise controls | ~15 min |