...
- Container registry ([Docker Hub](https://hub.docker.com) or [ECR](https://aws.amazon.com/ecr/))
...
For ECR, use `image_repo="[ACCOUNT_ID].dkr.ecr.[REGION].amazonaws.com"`.
  </Step>
...
Edit `prd_api_secrets.yml` and add your `OPENAI_API_KEY`. Edit `prd_db_secrets.yml` and set a secure database password.
  </Step>
