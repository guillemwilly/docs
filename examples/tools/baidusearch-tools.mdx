---
title: "Baidusearch"
description: "Use Baidusearch with Agno Agents."
---

Retrieve search results from Baidu with Agno Agents. Baidu Search provides access to Baidu's search index for finding relevant information.
...
```
For details, see [Baidu Search cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/91_tools/baidusearch_tools.py).