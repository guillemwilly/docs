...
description: "A runtime turns your agent into production software."
---

To build agentic products, you need to run your agents as horizontally scalable, durable services that are reachable over an API. That's what a runtime does.
...
<Note>
  AgentOS is not limited to just Agents. You can use it to build your own
  products, teams, and workflows. See [Build a
  Product](/runtime/build-a-product) for more information.
</Note>
