...
The full setup, including the Slack app manifest and the complete scope list, lives in the Dash repo: [SLACK_CONNECT.md](https://github.com/agno-agi/dash/blob/main/docs/SLACK_CONNECT.md).
...
Copy the manifest from [SLACK_CONNECT.md](https://github.com/agno-agi/dash/blob/main/docs/SLACK_CONNECT.md), paste into Slack's **Create New App → From a manifest** flow, and replace the placeholder URL with your URL from Step 1.
...
For everything else, see [SLACK_CONNECT.md](https://github.com/agno-agi/dash/blob/main/docs/SLACK_CONNECT.md).
