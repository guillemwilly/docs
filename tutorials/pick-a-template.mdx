...
The Agent Platform template is the leanest foundation: AgentOS, Postgres, Docker for local, Railway for production, two reference agents, and Claude Code prompts that build new agents for you.
