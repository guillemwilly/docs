...
Every analyst and every team writes to and reads from the same `team_learnings` store. An insight the risk officer captured this week is in the financial analyst's context next week.
...
| See it shared across seven analysts | [Example: Investment committee](/use-cases/deep-research/example-investment-committee) |
