...
| **Task** | `Team` (task mode) | Multi-step jobs the team decomposes autonomously |
...
| See all five in one system | [Example: Investment committee](/use-cases/deep-research/example-investment-committee) |
