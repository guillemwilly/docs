...
curl -X POST http://localhost:8000/workflows/investment-workflow/runs \
  ...
  -d '{"message":"Run a full review on NVDA","user_id":"pm@fund.com","session_id":"q4-review"}'
```
...
| See a served committee | [Example: Investment committee](/use-cases/deep-research/example-investment-committee) |
